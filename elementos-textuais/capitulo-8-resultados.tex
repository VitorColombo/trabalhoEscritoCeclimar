...
da versão 2.3.6 do aplicativo, que é a versão mais atualizada até o momento da entrega deste documento.
...
Esses testes foram executados manualmente, utilizando dispositivo físico e, por vezes, o Android Studio para emular o comportamento de alguns componentes do aplicativo em diferentes tamanhos de tela e versões do Android.
...
Esses testadores possuíam diversos perfis, incluindo dois usuários comuns, um pesquisador do CECLIMAR, e quatro usuários com experiência no desenvolvimento de software. Os testes foram realizados com 5 diferentes dispositivos, abrangendo uma variedade de tamanhos de tela e versões do Android, garantindo que o aplicativo fosse compatível com a maioria dos dispositivos utilizados pelos usuários finais (Tabela~\ref{tab:dispositivos-testados}).
...
Nas Tabelas~\ref{tab:fixes_sorted} e ~\ref{tab:dt_melhorias_sorted}, apresentadas anteriormente, é possível observar o número de demandas gerados e concluídos nessa etapa, divididos entre \textit{bugs} e melhorias/débitos técnicos. Ao todo, foram gerados \textbf{43} \textit{bugs} e \textbf{19} melhorias/débitos técnicos.

...
A aplicação \textit{mobile} foi lançada em 2014 e está disponível tanto para iOS quanto para Android (Figura~\ref{fig:sisgeoApp}) e possui mais de 10.000 \textit{downloads}, com avaliação média de 4,7/5 baseada em 116 avaliações de usuários. Foram registrados, até 26 de março de 2024, 33 mil registros e quase 13 mil usuários colaboradores.
...
O Sistema Urubu é uma iniciativa do Centro Brasileiro de Ecologia de Estradas da Universidade Federal de Lavras (UFLA), sob a coordenação do professor Alex Bager. Criado em 2014, o aplicativo de ciência cidadã é a maior rede para conservação da biodiversidade brasileira, destinada à coleta e gestão de informações de fauna selvagem ao longo de rodovias e ferrovias no Brasil. 

...
de dados da fauna costeira do litoral gaúcho. Diante dos desafios atuais, propõe-se o desenvolvimento de um aplicativo de 
...
de ter sido utilizada na análise de dados internos do CECLIMAR, conforme comentado na 
...
%A ferramenta escolhida para realizar este gerenciamento foi o \textit{Jira} \cite{atlassian_jira_2025}.
Para o acompanhamento deste projeto, foi utilizado um fluxo de trabalho no \textit{Jira} \cite{atlassian_jira_2025} com o propósito de auxiliar no processo de desenvolvimento e de manter a visibilidade das tarefas de ponta a ponta. Para o \textit{workflow} principal, foi utilizado um esquema com \textit{Backlog}\footnote{O \textit{Backlog} é uma lista ordenada e dinâmica de todo o trabalho necessário para o desenvolvimento de um produto. Ele funciona como a única fonte de requisitos e contém itens como novas funcionalidades, correções de \textit{bugs}, melhorias técnicas e outras tarefas.}, Refinamento, Em desenvolvimento, Aguardando teste, Em teste, Correção de \textit{bugs} e \textit{Done} (Figura~\ref{fig:fluxoJira}).
